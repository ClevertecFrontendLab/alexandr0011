...
export function ThirdStepRegistration({ userData, setUserData }) {
  ...
  return (
    <div data-test-id='auth'>
      <form className={styles.third_step_wrapper} onSubmit={handleSubmit(onSubmit)} data-test-id='register-form'>
        ...
        <div className={phoneWrapperStyle}>
          ...
          {!phone && <span data-test-id='hint' className={styles.error}>Поле не может быть пустым</span>}

          <span className={errors?.phone ? cn(styles.error, styles.gray) : styles.gray} data-test-id='hint'>
        ...
        <div className={emailWrapperStyle}>
          ...
          {!email && <span data-test-id='hint' className={styles.error}>Поле не может быть пустым</span>}
          {errors?.email && (
            <span data-test-id='hint' className={styles.error}>
