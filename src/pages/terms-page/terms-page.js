...
export function TermsPage({ pageName }) {
  return (
    <section className={styles.terms_wrapper}>
      <h1 className={styles.terms_title}>{pageName}</h1>
      <ul>
        <li className={styles.terms_clause}>
          ...
          <ul className={styles.terms_info}>
            <li>
        ...
        <li className={styles.terms_clause}>
          ...
          <ul className={styles.terms_info}>
            <li>
              ...
              участника как способного принимать собственные решения касаемо инновационных методов управления
              процессами.
              <ul className={styles.terms_info__list}>
                <li>
